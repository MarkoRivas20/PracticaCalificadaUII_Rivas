...
public class PacienteDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String id = getIntent().getStringExtra(MainActivity.EXTRA_PACIENTE_ID);

        PacienteDetailFragment fragment = (PacienteDetailFragment)getSupportFragmentManager().findFragmentById(R.id.medico_detail_container);

        if(fragment == null){
            fragment = PacienteDetailFragment.newInstance(id);
